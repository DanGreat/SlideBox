...
export class HealthCategoryPage implements OnInit {
  ...
  getNews() {
    ...
    .get(`https://newsapi.org/v2/top-headlines?country=ng&category=health&pageSize=8&page=${this.page}&apiKey=4f6e3e854d414e3b92fdac5c96c04102`)
    .subscribe((response) => {
      this.allNews = Array<any>(response);
      console.log("Health News", this.allNews);
